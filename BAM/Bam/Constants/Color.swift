...
class AppUsedColors {
    static let appColor = UIColor(red: 148/255, green: 122/255, blue: 99/255, alpha: 1)
    static let continueColor = UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 1)
    static let nextColor = UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 1)
    static let appBackgroundColor = UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 1)
   
    static let googleColor = UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 1)
    static let instagramColor = UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 1)
...
open class DatePickerDialog: UIView {
    ...
    private var bkgroundColor: UIColor!
    ...
    @objc public init(
        ...
        bkgroundColor: UIColor? = UIColor.black,
        ...
        self.bkgroundColor = bkgroundColor ?? Colors.accent
        self.font = font
    ...
    private func createContainerView() -> UIView {
        ...
        //Title
        self.titleLabel = UILabel(frame: CGRect(x: 0, y: 0, width: container.frame.width, height: 35))
        self.titleLabel.textAlignment = .center
        self.titleLabel.textColor = self.textColor
        self.titleLabel.backgroundColor = self.bkgroundColor
    ...
    fileprivate func configuredDatePicker() -> UIDatePicker {
        let datePicker = UIDatePicker(frame: CGRect(x: 0, y: 35, width: 0, height: 0))
    ...
    private func addButtonsToView(container: UIView) {
        var buttonWidth = (container.bounds.size.width - 1) / 2
        ...
        if showCancelButton {
            ...
            self.cancelButton.setTitleColor(self.textColor, for: .normal)
            self.cancelButton.setTitleColor(self.textColor, for: .highlighted)
            self.cancelButton.backgroundColor = self.bkgroundColor
...
//            self.cancelButton.layer.cornerRadius = kCornerRadius
        ...
        self.doneButton.setTitleColor(self.textColor, for: .normal)
        self.doneButton.setTitleColor(self.textColor, for: .highlighted)
        self.doneButton.backgroundColor = self.bkgroundColor
